...
top level, we have "com", at the next level, we have "leetcode.com", and at the lowest 
level, "discuss.leetcode.com". When we visit a domain like "discuss.leetcode.com", we 
...
Now, call a "count-paired domain" to be a count (representing the number of visits 
    this domain received), followed by a space, followed by the address. An example 
...
subdomain "leetcode.com" and "com" will also be visited. So they will all be visited 
9001 times.
...
once and "wiki.org" 5 times. For the subdomains, we will visit "mail.com" 900 + 1
